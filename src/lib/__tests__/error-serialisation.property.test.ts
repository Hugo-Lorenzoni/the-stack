...
const namedErrorArb = fc
  .tuple(
    fc.constantFrom('TypeError', 'RangeError', 'ReferenceError', 'SyntaxError', 'URIError', 'EvalError'),
...
describe('Property 13: When wideEvent.error is set, it is always a plain object { message: string, type: string } and never a raw Error instance or undefined', () => {
  ...
  it(
    'withLogging: wideEvent.error is never a raw Error instance when handler throws any Error',
    async () => {
      await fc.assert(
        fc.asyncProperty(
          errorInstanceArb,
  ...
  it(
    'withLogging: wideEvent.error.message is always a string when handler throws any Error',
    async () => {
      await fc.assert(
        fc.asyncProperty(
          errorInstanceArb,
  ...
  it(
    'withLogging: wideEvent.error.type is always a string when handler throws any Error',
    async () => {
      await fc.assert(
        fc.asyncProperty(
          errorInstanceArb,
  ...
  it(
    'withLogging: wideEvent.error is a plain object with exactly { message, type } when handler throws a named Error subclass',
    async () => {
      await fc.assert(
        fc.asyncProperty(
          namedErrorArb,
  ...
  it(
    'withLogging: wideEvent.error is always a plain { message: string, type: string } for any thrown value',
    async () => {
      await fc.assert(
        fc.asyncProperty(
          anyThrowableArb,
  ...
  it(
    'withLogging: wideEvent.error is not set (undefined) when handler succeeds',
    async () => {
      await fc.assert(
        fc.asyncProperty(
